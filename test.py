...
restore_transform = standard_transforms.Compose([
        own_transforms.DeNormalize(cfg.TRAIN.mean_std),
...
def main():
	...
	if not os.path.exists(os.path.join(cfg.TRAIN.CKPT_PATH, cfg.TRAIN.EXP_NAME)):
	    os.mkdir(os.path.join(cfg.TRAIN.CKPT_PATH, cfg.TRAIN.EXP_NAME))

	if not os.path.exists(cfg.TRAIN.EXP_LOG_PATH):
	    os.mkdir(cfg.TRAIN.EXP_LOG_PATH)
